...
const AdminDashboard = () => {
  ...
  if (loading) return <p className="text-xl font-semibold p-4 text-center">Loading dashboard...</p>;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-blue-300">
      ...
      <div className="p-6 pt-24 max-w-7xl mx-auto space-y-6">
        ...
        {/* --- Admin Management --- */}
        <section className="p-6 bg-white/70 backdrop-blur-xl border border-gray-200 rounded-2xl shadow-lg space-y-6">
          <h2 className="text-2xl font-semibold text-gray-700">Admin Management</h2>

          {/* Departments */}
          <div className="space-y-2">
            <h3 className="font-semibold text-gray-600">Departments</h3>
          ...
          {/* Assign Officers */}
          <div className="space-y-2">
            <h3 className="font-semibold text-gray-600">Assign Officers</h3>
            <div className="flex gap-3 flex-wrap">
              <select
          ...
          {/* Manage Roles */}
          <div className="space-y-2">
            <h3 className="font-semibold text-gray-600">Manage Roles</h3>
            <div className="flex gap-3 flex-wrap">
              <select
        ...
        {/* --- Statistics --- */}
        <section className="p-6 bg-white/70 backdrop-blur-xl border border-gray-200 rounded-2xl shadow-lg">
